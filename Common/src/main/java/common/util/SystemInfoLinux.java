...
public class SystemInfoLinux {
    private static final Logger log = LogManager.getLogger(SystemInfoLinux.class.getName());
     ...
     */
    public SystemInfoLinux(String procfsMemFile,
    ...
    public static void main(String[] args) {
        SystemInfoLinux plugin = new SystemInfoLinux();
    ...
    private static final SystemInfoLinux instance = new SystemInfoLinux();

    public static SystemInfoLinux newInstance() {
        return instance;
    }
}
